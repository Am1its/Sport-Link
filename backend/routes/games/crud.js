...
// GET /api/games/mine — requires auth; must be registered before /:id
...
// GET /api/games/:id — single game detail (auth-optional)
...
router.post('/', authMiddleware, async (req, res) => {
  ...
  try {
    ...
    // Pre-add invited friends — verify they are accepted friends first
...
// DELETE /api/games/:id — host only; cancels game and notifies participants
